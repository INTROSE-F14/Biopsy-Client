...
public class GynecologyForm extends JPanel implements Form
{
	...
	{	
		...
		refNumberValue.setFont(MainMenu.PRIMARY_FONT.deriveFont(Font.BOLD).deriveFont(MainMenu.SUBHEADER));
		specimenValue.setHorizontalAlignment(JTextField.CENTER);
		specimenValue.setFont(MainMenu.PRIMARY_FONT.deriveFont(MainMenu.SUBHEADER));
		...
		diagnosisValue.setFont(specimenValue.getFont().deriveFont(MainMenu.MENU));
	...
	public Object getObject()
	{
		...
		record.putAttribute(RecordTable.RECORD_TYPE.toString(), DetailPanel.GYNECOLOGY);
