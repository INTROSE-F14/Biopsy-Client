...
public class HistopathologyForm extends JPanel implements Form
{
	...
	private JTextArea grossDescValue;
	private JTextArea microNoteValue;
	private JScrollPane diagnosisScroller;
	private JScrollPane remarksScroller;
	private JScrollPane grossDescScroller;
	private JScrollPane microNoteScroller;
	...
	private JLabel grossDescLabel;
	private JLabel microNoteLabel;
	...
	private void layoutComponents()
	{
		...
		c.insets = new Insets(0,0,0,0);
		c.anchor = GridBagConstraints.LINE_START;
		insidePanel.add(grossDescLabel, c);
		c.fill = GridBagConstraints.HORIZONTAL;
		c.gridx = 0;
		c.gridy = y++;
		c.gridwidth = 2;
		c.insets = new Insets(0,0,10,0);
		insidePanel.add(grossDescScroller, c);
		c.fill = GridBagConstraints.NONE;
		c.gridy = y++;
		c.gridx = 0;
		c.gridwidth = 1;
		c.insets = new Insets(0,0,0,0);
		insidePanel.add(microNoteLabel, c);
		c.fill = GridBagConstraints.HORIZONTAL;
		c.gridx = 0;
		c.gridy = y++;
		c.gridwidth = 2;
		insidePanel.add(microNoteScroller, c);
	...
	{	
		...
		grossDescValue = new JTextArea(3,30);
		microNoteValue = new JTextArea(3,30);
		...
		grossDescScroller.setPreferredSize(new Dimension(500, 70));
		microNoteScroller.setPreferredSize(new Dimension(500, 70));
	...
	public Object getObject()
	{
		...
		//IMPLEMENT GROSS DESC AND MICROSCOPIC NOTE HERE
