...
public class NavigationPanel extends JPanel
{
	...
	public NavigationPanel()
	{
		...
		recordsPanelHeader.setFont(MainMenu.PRIMARY_FONT.deriveFont(Constants.StyleConstants.HEADER));
		...
		maintenanceHeader.setFont(MainMenu.PRIMARY_FONT.deriveFont(Constants.StyleConstants.HEADER));
		...
		othersHeader.setFont(MainMenu.PRIMARY_FONT.deriveFont(Constants.StyleConstants.HEADER));
